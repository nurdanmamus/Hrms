...
public class JobseekerManager implements JobseekerService {
	...
	public Result add(JobseekerDto jobseekerDto) {
		...
		if (this.jobseekerDao.existsByEmailOrTckn(jobseekerDto.getEmail(), jobseekerDto.getTckn())){
			return new ErrorResult("The user exists in the system");		
		} 
		
		
		if (!this.userCheckService.CheckIfRealPerson(jobseekerDto.getTckn(), jobseekerDto.getName(),
